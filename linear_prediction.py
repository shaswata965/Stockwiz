...
def prediction(predict, stock_name):
    ...
    # X_train = market_prediction.train_data(cur_set - 18, stock_name, predict)[0]
    #
    # X_train = np.array(X_train)
    #
    # Y_train = market_prediction.train_data(cur_set - 18, stock_name, predict)[1]
    #
    # Y_train = np.array(Y_train)
    #
    # X_test = market_prediction.train_data(cur_set - 17, stock_name, predict)[0]
    #
    # Y_test = market_prediction.train_data(cur_set - 17, stock_name, predict)[1]
    #
    lm = LinearRegression()
